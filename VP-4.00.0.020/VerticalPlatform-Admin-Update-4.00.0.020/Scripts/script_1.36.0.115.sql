...
BEGIN
	...
	WHERE 
		...
		(@sortBy = 'created' AND @sortOrder = 'desc' AND createdDesc BETWEEN @startIndex AND @endIndex) OR 
		(@sortBy = 'modified' AND @sortOrder = 'desc' AND modifiedDesc BETWEEN @startIndex AND @endIndex)
	ORDER BY
		CASE 
