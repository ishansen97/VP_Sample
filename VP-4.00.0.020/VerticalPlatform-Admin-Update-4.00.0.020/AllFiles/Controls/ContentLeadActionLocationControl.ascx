<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContentLeadActionLocationControl.ascx.cs" 
	Inherits="VerticalPlatformAdminWeb.Controls.ContentLeadActionLocationControl" %>

<script src="../Js/Location.js" type="text/javascript"></script>

<div class="actionLocations">
	<div class="locations">
	...
	<asp:Button ID="btnAddLocation" runat="server" Text="Add Location" CssClass="common_text_button location_btn" OnClick="btnAddLocation_Click" />
	<asp:GridView ID="locations" runat="server" AutoGenerateColumns="false" CssClass="common_data_grid"
		OnRowCommand="locations_RowCommand" OnRowDataBound="locations_RowDataBound">
		<Columns>
