...
WYMeditor.editor.prototype.paste = function(sData) {
	...
	//Modifying the paste function to get rid of the <p> tag that is added when inserting html.
	...
	//Modified code to remove the additional <p> tag.
	if (container && container.tagName.toLowerCase() != WYMeditor.BODY) {
		for (x = aP.length - 1; x >= 0; x--) {
			sTmp = aP[x];
			//simple newlines are replaced by a break
...
WYMeditor.XhtmlValidator = {
  ...
  "_tags":
  {
    ...
    "28": "ol",
    "ol": // Editor patch to suport attributes in ordered list.
 	{
 	      "attributes": 
 	      { 
 	        "0": "compact", 
