...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RapidMasterDataSyncTaskSetting.ascx.cs" Inherits="VerticalPlatformAdminWeb.Platform.Task.RapidMasterDataSyncTaskSetting" %>
