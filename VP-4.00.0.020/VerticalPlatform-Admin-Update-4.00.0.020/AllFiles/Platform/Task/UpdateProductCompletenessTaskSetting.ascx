<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpdateProductCompletenessTaskSetting.ascx.cs" Inherits="VerticalPlatformAdminWeb.Platform.Task.UpdateProductCompletenessTaskSetting" %>
