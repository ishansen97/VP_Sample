<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductChangeTrackingTaskSetting.ascx.cs" Inherits="VerticalPlatformAdminWeb.Platform.Task.ProductChangeTrackingTaskSetting" %>
