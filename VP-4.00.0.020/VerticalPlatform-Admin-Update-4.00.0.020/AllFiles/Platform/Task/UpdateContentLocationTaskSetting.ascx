<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpdateContentLocationTaskSetting.ascx.cs"
	Inherits="VerticalPlatformAdminWeb.Platform.Task.UpdateContentLocationTaskSetting" %>
