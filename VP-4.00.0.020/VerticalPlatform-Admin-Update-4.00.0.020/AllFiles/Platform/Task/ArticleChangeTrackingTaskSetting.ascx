<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ArticleChangeTrackingTaskSetting.ascx.cs" Inherits="VerticalPlatformAdminWeb.Platform.Task.ArticleChangeTrackingTaskSetting" %>
