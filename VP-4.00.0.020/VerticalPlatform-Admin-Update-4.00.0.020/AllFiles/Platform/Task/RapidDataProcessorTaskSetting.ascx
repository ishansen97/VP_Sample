...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RapidDataProcessorTaskSetting.ascx.cs" Inherits="VerticalPlatformAdminWeb.Platform.Task.RapidDataProcessorTaskSetting" %>
