<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RecreateFullTextCatalogTaskSetting.ascx.cs" 
Inherits="VerticalPlatformAdminWeb.Platform.Task.RecreateFullTextCatalogTaskSetting" %>
