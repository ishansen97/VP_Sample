<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ArchiveSolutionProductSyncTaskSetting.ascx.cs" Inherits="VerticalPlatformAdminWeb.Platform.Task.ArchiveSolutionProductSyncTaskSetting" %>
