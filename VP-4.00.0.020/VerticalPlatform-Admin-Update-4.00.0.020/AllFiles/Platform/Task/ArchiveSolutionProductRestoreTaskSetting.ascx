<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ArchiveSolutionProductRestoreTaskSetting.ascx.cs" Inherits="VerticalPlatformAdminWeb.Platform.Task.ArchiveSolutionProductRestoreTaskSetting" %>
