<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CreateSegmentRecipientsReportTaskSetting.ascx.cs" 
Inherits="VerticalPlatformAdminWeb.Platform.Task.CreateSegmentRecipientsReportTaskSetting" %>
