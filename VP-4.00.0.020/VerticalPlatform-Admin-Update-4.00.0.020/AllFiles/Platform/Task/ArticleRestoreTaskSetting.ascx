...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ArticleRestoreTaskSetting.ascx.cs" Inherits="VerticalPlatformAdminWeb.Platform.Task.ArticleRestoreTaskSetting" %>
