<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SliderContainerSettings.ascx.cs" Inherits="VerticalPlatformAdminWeb.Platform.ModuleInstanceSettings.SliderContainerSettings" %>
<table>
	<tr>
		<td>
			Display Title
