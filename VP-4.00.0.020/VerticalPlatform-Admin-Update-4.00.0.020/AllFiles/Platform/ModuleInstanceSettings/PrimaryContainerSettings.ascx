<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrimaryContainerSettings.ascx.cs" Inherits="VerticalPlatformAdminWeb.Platform.ModuleInstanceSettings.PrimaryContainerSettings" %>
<table>
	<tr>
		<td>
			Display Title
