<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RecentForumThreadsSettings.ascx.cs" 
Inherits="VerticalPlatformAdminWeb.Platform.ModuleInstanceSettings.ForumRecentThreadListSettings" %>
