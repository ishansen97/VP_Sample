<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddCategorySearchGroupSearchOptions.ascx.cs"
	Inherits="VerticalPlatformAdminWeb.ModuleAdmin.Category.AddCategorySearchGroupSearchOptions" %>
...
<div style="width: 500px">
	<div runat="server" id="divSelectedOptions">
		<div class="add-button-container">
			<asp:Button ID="btnAddOption" runat="server" Text="Add Search Options" CssClass="btn"
	...
	<div runat="server" id="divAddOptions">
		<asp:Button ID="btnBack" runat="server" Text="&laquo; Back" CssClass="btn" OnClick="btnBack_Click" />
		<br />
		<br />
		...
		<div id="divSearchPane" class="article_srh_pane" style="display: none;">
			<div class="inline-form-container">
				<label>
					Search Option Name</label>
				<div class="input-append">
					<asp:TextBox runat="server" ID="txtOptionName" Width="140px" MaxLength="200"></asp:TextBox>
		...
		<br />
		<div class="add-button-container">
			<asp:LinkButton ID="lbtnAddAll" runat="server" Text="Add All Search Options" OnClick="lbtnAddAll_Click"
				CssClass="btn"></asp:LinkButton></div>
		<asp:GridView ID="gvSearchOptionList" runat="server" AutoGenerateColumns="False"
			...
			<Columns>
				...
				<asp:TemplateField HeaderText="Sort Order">
					<ItemTemplate>
						<asp:TextBox ID="txtSortOrder" Width="60" runat="server" Text="1"></asp:TextBox>
					</ItemTemplate>
				</asp:TemplateField>
				<asp:TemplateField>
					<ItemTemplate>
						<asp:LinkButton runat="server" ID="lbtnAdd" CommandName="AddOption" ToolTip="Add"
							CssClass="grid_icon_link add">Add</asp:LinkButton>
					</ItemTemplate>
				</asp:TemplateField>
			</Columns>
			<EmptyDataTemplate>
