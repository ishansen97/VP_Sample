<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductUrlLocation.ascx.cs" Inherits="VerticalPlatformAdminWeb.ModuleAdmin.Product.ProductUrlLocation" %>
