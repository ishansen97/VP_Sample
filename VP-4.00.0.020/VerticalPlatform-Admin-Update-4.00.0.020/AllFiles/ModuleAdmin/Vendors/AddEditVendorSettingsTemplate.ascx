<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddEditVendorSettingsTemplate.ascx.cs" Inherits="VerticalPlatformAdminWeb.ModuleAdmin.Vendors.AddEditVendorSettingsTemplate" %>
<table>
	<tr>
		<td>
	...
	<tr>
	<td><asp:CheckBox ID="chkUpdateAllProducts" runat="server" Text="Update All Products" /></td>
	</tr>
</table>
